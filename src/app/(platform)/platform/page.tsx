  ...
  return (
    <main className="flex flex-col gap-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold">행사(프로그램) 목록</h1>
          <p className="mt-1 text-sm text-muted-foreground">이 플랫폼에 개설된 모든 행사입니다. 행사마다 계정·그룹·케이스·단가·브랜딩이 완전히 분리됩니다.</p>
        </div>
