...
export const metadata: Metadata = {
  title: '개인정보처리방침',
  description: '대전 소상공인·자영업자 재기지원 플랫폼 개인정보처리방침',
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        대전일자리경제진흥원(이하 &lsquo;진흥원&rsquo;)은 「개인정보 보호법」 제30조에 따라 정보주체의
      ...
      <section className="prose prose-sm mt-8 max-w-none space-y-6 text-sm leading-relaxed">
        <div>
          ...
          <p>
            재기지원(컨설팅·경영개선) 사업 신청·심사·집행·정산, 멘토링 운영, 지원금 지급, 사후관리 및
        ...
        <div>
          ...
          <p>
            ...
            운영기관((주)넥스트랩)에 처리를 위탁하며, 법령에 근거가 있거나 정보주체의 동의가 있는 경우에
            한하여 제공합니다.
          </p>
        </div>
        <div>
          ...
          <p>
            정보주체는 언제든지 개인정보 열람·정정·삭제·처리정지를 요구할 수 있으며, 진흥원은 지체 없이
            필요한 조치를 취합니다.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            진흥원은 개인정보 처리에 관한 업무를 총괄하여 책임지고, 정보주체의 불만처리 및 피해구제를
            위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
          </p>
          <ul className="mt-1 list-disc pl-5">
            <li>개인정보 보호책임자: 대전일자리경제진흥원 경영관리 부서장</li>
            <li>문의·열람·정정·삭제 접수: 대전일자리경제진흥원 대표 연락처 및 본 플랫폼 운영기관((주)넥스트랩)</li>
          </ul>
        </div>
        <div>
